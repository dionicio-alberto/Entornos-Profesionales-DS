# Final Proyect guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `final_proyect/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `final_proyect` folder and use the modules inside your notebooks :
...
```python
from final_proyect.utils.paths import data_dir
data_dir()
```
